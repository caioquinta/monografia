...
\par Ao todo 25 pessoas responderam ao questionário, sendo que todas acreditam que uma plataforma centralizando Eventos na USP é fato útil e dessas apenas 3 não gostaram do USP Eventos.
\par Dentre as críticas das 3 pessoas que não gostaram as críticas foram:
\begin{itemize}
\item Acreditam que poucas pessoas hoje usariam um site e talvez uma iniciativa dentro do Facebook fosse mais útil.
...
\par Utilizar um Mapa de Calor foi um acréscimo importante na coleta de fados pois foi possível perceber detalhes na forma como o usuário utiliza a plataforma tornando-se mais uma opção para realizar a validação da hipótese inicial.
