...
\par Visando tornar a navegação dentro da página de eventos mais fluída e menos cansativa fora realizadas algumas modificações visuais na exibiçãodos eventos (figura  \ref{fig:events_pagev2})
\begin{itemize}
