...
\end{figure}
\par Combinando os benefícios herdados pela Metodologia Ágil e somando-se a isso um arcabouço para adquirir aprendizado sobre a utilização do software o ciclo de Construir-Medir-Aprender resulta em um software mais refinado e alinhado com as expectativas dos clientes.
