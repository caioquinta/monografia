...
\par Essa economia em cada ciclo provém do \emph{validated learning} (Aprendizado comm validação), ou seja, toda ideia, funcionalidade ou vertente de produto deve ser primeiramente experimentada e testada.
...
\par A popularidade Steve Blank foi em adaptar a estratégia incluindo o lado do cliente na balança, o que ele chama de \emph{Customer Development}. Blank vai além de apenas minimizar o risco de retorno: busca compreender as necessidades do cliente.
...
\end{enumerate}
    ...
    \par Os termos "mínimo" e "máximo" referentes a "máximo aprendizado" e "mínimo produto viável" frequentemente se mostram vagos na documentação do que é um MVP, como o próprio Eric Ries esclarece a aplicação desse termos não é um conceito rigido e varia de acordo om o contexto e julgamento de quem estiver aplicando-o \footnote{Fonte: Startup Lessons Learned, Minimum Viable Product: a guide \url{http://www.startuplessonslearned.com/2009/08/minimum-viable-product-guide.html}}. 
